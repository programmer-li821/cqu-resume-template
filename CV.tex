...
\end{tikzpicture}%
%%%% 利用tikz来定位重庆大学Logo（矢量版）
\begin{tikzpicture}[remember picture, overlay] 
    \node[anchor = north west, inner sep=0pt] at ($(current page.north west)+(0.5cm,-1.0cm)$) 
    {\includegraphics[height=1.8cm]{cqu-logo}}; % 矢量图后缀 .pdf 或 .eps 可省略
\end{tikzpicture}%
\centerline{\LARGE\bfseries{小李}} 

\centerline{\normalsize{\faPhone\ 111-1111-1111 \quad \faEnvelopeO\ \href{mailto:3230100000@cqu.edu.cn}{3230100000@cqu.edu.cn}}} 

    
\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faGraduationCap}\ 教育背景}    
\textbf{重庆大学} \hfill 2023.9 -- 至今\\[0.5em] % 标题和正文间加一点距离
